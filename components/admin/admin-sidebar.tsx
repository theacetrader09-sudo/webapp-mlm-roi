...
export default function AdminSidebar() {
  ...
  return (
    <div className="fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-purple-900 to-purple-800 shadow-lg">
      <div className="flex flex-col h-full">
        ...
        <div className="border-t border-purple-700 p-4">
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-purple-200 hover:bg-purple-700/50 hover:text-white transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
